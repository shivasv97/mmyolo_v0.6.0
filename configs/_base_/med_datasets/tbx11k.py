...
data_root = '/scratch/jliang12/data/tbx11k/tbx11k/TBX11K/'  # Root path of data
# data_root = '/anvil/projects/x-med220025/datasets/vindr_cxr/1.0.0/'  # Root path of data
# Path of train annotation file
train_ann_file = 'annotations/all_train_2.json'
train_data_prefix = 'imgs/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'annotations/all_val_2.json'
val_data_prefix = 'imgs/'  # Prefix of val image path
test_ann_file = 'annotations/all_val_2.json'
test_data_prefix = 'imgs/'  # Prefix of val image path
