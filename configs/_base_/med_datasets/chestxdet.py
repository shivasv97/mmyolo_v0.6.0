...
data_root = '/scratch/jliang12/data/ChestX-Det/'  # Root path of data
# data_root = '/anvil/projects/x-med220025/datasets/vindr_cxr/1.0.0/'  # Root path of data
# Path of train annotation file
train_ann_file = 'ChestX_det_train_NAD_v2.json'
train_data_prefix = 'train/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'ChestX_det_test_NAD_v2.json'
val_data_prefix = 'test/'  # Prefix of val image path
test_ann_file = 'ChestX_det_test_NAD_v2.json'
...
class_name = ( 'Atelectasis', 'Calcification', 'Cardiomegaly', 'Consolidation', 'Diffuse Nodule', 'Effusion', 'Emphysema', 'Fibrosis', 'Fracture', 'Mass', 'Nodule', 'Pleural Thickening', 'Pneumothorax')
