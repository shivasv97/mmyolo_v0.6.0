...
data_root = '/scratch/jliang12/data/NODE21/cxr_images/proccessed_data/'  # Root path of data
# data_root = '/anvil/projects/x-med220025/datasets/vindr_cxr/1.0.0/'  # Root path of data
# Path of train annotation file
train_ann_file = 'Node21_Nodule_Bbox_Ann_train_2.json'
train_data_prefix = 'images_png/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'Node21_Nodule_Bbox_Ann_test_2.json'
val_data_prefix = 'images_png/'  # Prefix of val image path
test_ann_file = 'Node21_Nodule_Bbox_Ann_test_2.json'
test_data_prefix = 'images_png/'  # Prefix of val image path
